        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">Toserda</a>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jalan menuju tak terbatas</li>
                <li class="phone"><a href="tel://23923929210">+62 8123456789</a></li>
                <li class="email">Toserda@gmail.com</li>
              </ul>
            </div>
