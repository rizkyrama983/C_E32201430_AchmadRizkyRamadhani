    ...
    <div class="row">
        ...
        <div class="row justify-content-end">
            ...
            <div class="row">
                @if($cekalamat > 0)
                <div class="col-md-12">
                <a href="Https://wa.me/6289683587371" class="btn btn-primary btn-lg py-3 btn-block" >Beli Sekarang</a>
                <small>Harap sediakan screnshot halaman ini sebelum klik beli sekarang</small>
                </div>
                @else
                <div class="col-md-12">
