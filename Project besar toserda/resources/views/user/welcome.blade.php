...
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/hero_1.jpg);" data-aos="fade">
    ...
    <div class="row align-items-start align-items-md-center justify-content-end">
        ...
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Berbagai macam barang disini terjamin kualitasnya dan tentunya barangnya juga original bukan kw. </p>
            <p>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            ...
            <p>Pengiriman bisa ke seluruh wilayah indonesia dengan kurir Apa Saja</p>
        </div>
        </div>
